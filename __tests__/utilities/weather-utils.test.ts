...
import {flightCategories, metarFlightCategories, tafFlightCategories} from "../../src/utilities/weather-utils";
...
describe("weather-utils.ts", () => {
    ...
    test("flightCategories()", () => {
        ...
        expect(intervals).toStrictEqual([{
            ...
            category: "IFR",
            interval: Interval.fromISO("2023-06-25T03:20:00.000Z/2023-06-25T03:36:00.000Z", {setZone: true})
        }, {
            category: "IFR",
            interval: Interval.fromISO("2023-06-25T03:36:00.000Z/2023-06-25T03:45:00.000Z", {setZone: true})
        }, {
            category: "MVFR",
            ...
            category: "MVFR",
            interval: Interval.fromISO("2023-06-25T12:02:00.000Z/2023-06-25T16:00:00.000Z", {setZone: true})
        }, {
            category: "VFR",
