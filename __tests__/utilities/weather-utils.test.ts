...
import {
    flightCategories,
    metarFlightCategories,
    tafCategories
} from "../../src/utilities/weather-utils";

describe("weather-utils.ts", () => {
    describe("flightCategories()", () => {
        test("2023-06-26", () => {
            const taf = parseTAF([
            ...
            const intervals = flightCategories(reference, taf, metars);
            expect(intervals).toStrictEqual([{
                category: "VFR",
                interval: Interval.fromISO("2023-06-25T18:53:00.000Z/2023-06-26T02:53:00.000Z", {setZone: true})
            }, {
                category: "MVFR",
                interval: Interval.fromISO("2023-06-26T02:53:00.000Z/2023-06-26T03:26:00.000Z", {setZone: true})
            }, {
                category: "VFR",
                interval: Interval.fromISO("2023-06-26T03:26:00.000Z/2023-06-26T03:53:00.000Z", {setZone: true})
            }, {
                category: "MVFR",
                interval: Interval.fromISO("2023-06-26T03:53:00.000Z/2023-06-26T06:03:00.000Z", {setZone: true})
            }, {
                category: "VFR",
                interval: Interval.fromISO("2023-06-26T06:03:00.000Z/2023-06-26T07:07:00.000Z", {setZone: true})
            }, {
                category: "MVFR",
                interval: Interval.fromISO("2023-06-26T07:07:00.000Z/2023-06-27T00:00:00.000Z", {setZone: true})
            }]);
        });
        test("2023-06-28", () => {
            const taf = parseTAF([
                "KMSN 281120Z 2812/2912 15006KT 1 1/2SM FU BKN028",
                "FM281500 16007KT 2SM FU BKN035",
                "FM282000 16010KT 4SM FU SCT035 BKN100",
                "PROB30 2903/2909 -TSRA BKN020 OVC035CB",
                "FM291000 17006KT 6SM FU SCT015"
            ].join("\n"));
            const metars = [
            ...
            const reference = DateTime.fromISO("2023-06-28T12:00:00.000Z", {setZone: true});
            const intervals = flightCategories(reference, taf, metars);
            expect(intervals).toStrictEqual([
                {
                    category: "IFR",
                    interval: Interval.fromISO("2023-06-27T23:53:00.000Z/2023-06-28T11:53:00.000Z", {setZone: true})
                },
                {
                    category: "IFR",
                    interval: Interval.fromISO("2023-06-28T12:00:00.000Z/2023-06-29T12:00:00.000Z", {setZone: true})
                },
                {
                    category: "MVFR",
                    interval: Interval.fromISO("2023-06-28T20:00:00.000Z/2023-06-29T12:00:00.000Z", {setZone: true})
                },
                {
                    category: "VFR",
                    interval: Interval.fromISO("2023-06-29T10:00:00.000Z/2023-06-29T12:00:00.000Z", {setZone: true})
                }
            ]);
        });
    });
    test("metarFlightCategories()", () => {
        const metars = [
        ...
        const reference = DateTime.fromISO("2023-06-24T12:34:56.789Z", {setZone: true});
        const intervals = metarFlightCategories(reference, metars);
        expect(intervals).toStrictEqual([{
            category: "VFR",
            interval: Interval.fromISO("2023-06-24T23:53:00.000Z/2023-06-25T03:13:00.000Z", {setZone: true})
        }, {
            category: "MVFR",
            interval: Interval.fromISO("2023-06-25T03:13:00.000Z/2023-06-25T03:20:00.000Z", {setZone: true})
        }, {
            category: "IFR",
            interval: Interval.fromISO("2023-06-25T03:20:00.000Z/2023-06-25T03:40:00.000Z", {setZone: true})
        }, {
            category: "LIFR",
            interval: Interval.fromISO("2023-06-25T03:40:00.000Z/2023-06-25T03:45:00.000Z", {setZone: true})
        }, {
            category: "MVFR",
            interval: Interval.fromISO("2023-06-25T03:45:00.000Z/2023-06-25T04:15:00.000Z", {setZone: true})
        }, {
            category: "VFR",
            interval: Interval.fromISO("2023-06-25T04:15:00.000Z/2023-06-25T12:02:00.000Z", {setZone: true})
        }, {
            category: "MVFR",
            interval: Interval.fromISO("2023-06-25T12:02:00.000Z/2023-06-25T13:53:00.000Z", {setZone: true})
        }]);
    });
    describe("tafCategories()", () => {
        test("2023-06-25", () => {
            const taf = parseTAF([
            ...
            const reference = DateTime.fromISO("2023-06-24T12:34:56.789Z", {setZone: true});
            const intervals = tafCategories(reference, taf).map(({interval, ...rest}) => ({
                interval: interval.toISO(),
                ..._.omit(rest, "source")
            }));
            expect(intervals).toStrictEqual([{
                interval: "2023-06-25T14:00:00.000Z/2023-06-26T12:00:00.000Z",
                category: "mvfr",
                confidence: "forecast"
            }, {
                interval: "2023-06-25T16:00:00.000Z/2023-06-26T12:00:00.000Z",
                category: "vfr",
                confidence: "forecast"
            }, {
                interval: "2023-06-25T21:00:00.000Z/2023-06-26T12:00:00.000Z",
                category: "vfr",
                confidence: "forecast"
            }, {
                interval: "2023-06-26T03:00:00.000Z/2023-06-26T12:00:00.000Z",
                category: "ifr",
                confidence: "forecast"
            }, {
                interval: "2023-06-26T03:00:00.000Z/2023-06-26T04:00:00.000Z",
                category: "mvfr",
                confidence: 0.3
            }]);
        });
        test("2023-06-28", () => {
            ...
            expect(intervals).toStrictEqual([
                {
                    interval: "2023-06-28T12:00:00.000Z/2023-06-29T12:00:00.000Z",
                    category: "ifr",
                    confidence: "forecast"
                },
                {
                    interval: "2023-06-28T15:00:00.000Z/2023-06-29T12:00:00.000Z",
                    category: "ifr",
                    confidence: "forecast"
                },
                {
                    interval: "2023-06-28T20:00:00.000Z/2023-06-29T12:00:00.000Z",
                    category: "mvfr",
                    confidence: "forecast"
                },
                {
                    interval: "2023-06-29T03:00:00.000Z/2023-06-29T09:00:00.000Z",
                    category: "ifr",
                    confidence: 0.3
                },
                {
                    interval: "2023-06-29T10:00:00.000Z/2023-06-29T12:00:00.000Z",
                    category: "vfr",
                    confidence: "forecast"
                }
            ]);
