...
export default function Home() {
    return (
        <>
            <section className="flex flex-col space-y-3 text-justify md:flex-row md:space-x-3 place-items-center">
                ...
                <div className="md:w-1/3">
                    <div
                        ...
                        <p>
                            <span className="text-xl font-extrabold">Capitol City Flyers</span> is Madison's premier
                            member-owned flying club, operating out of <a href="https://www.msnairport.com/">Dane County
                            Regional Airport</a> for over 60 years. We own and operate 3 IFR-certified aircraft:
                            a <a href="src/main/webpack/pages/index#">Diamond DA40</a> with a Garmin G1000 glass
                            cockpit, a <a href="src/main/webpack/pages/index#">Cessna Skylane</a> with retractable
                            landing gear, and a <a href="src/main/webpack/pages/index#">Piper Archer</a>. Come join our
                            group of like minded pilots!
                        </p>
                        <p>
