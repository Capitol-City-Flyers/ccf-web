...
describe("TestDataUtils", () => {
    ...
    describe("readUtf8TextResources()", () => {
        test("Reads the full contents of test data files", async () =>
            readUtf8TextResources("./cycles/noaa/taf/taf-20230429-*.txt.br")
                .then(matches => {
                    ...
                    expect(_.sortBy(hashes)).toStrictEqual([
                        ["taf-20230429-00Z.txt.br", "643ad7b3b234e2b6e8e5e9d86953bb4bed424bf1afa02dbbf6df924119a64cf5"],
                        ["taf-20230429-06Z.txt.br", "b3c85c8a796818ae2e75458f4f446ac9a423443d583c3989c14a5492cb21e114"],
                        ["taf-20230429-12Z.txt.br", "f3984573cea24cb021af97b7097987f2b751a9457ba289d3418a0c3df2c42341"],
                        ["taf-20230429-18Z.txt.br", "4d033d4538a59e1a6e552136e1cffb70114d8ad61d42879a881a7c3ccd05384f"]
                    ]);
                }));
    });
});
