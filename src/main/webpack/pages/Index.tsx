...
import fleetJpg from "../assets/images/cap-city-flyers-fleet.jpg";
import {AircraftGallery} from "../components/aircraft/AircraftGallery";
import {CLUB_DATA} from "../data";

export default function Index() {
    const {aircraft} = CLUB_DATA;
    return (
        <>
            <section className="flex flex-col space-y-3 md:flex-row md:space-x-3 place-items-center">
                ...
                <div className="md:w-1/3">
                    <div
                        ...
                        <div className="text-justify">
                            ...
                            a <a className="drop-shadow-md" href="src/main/webpack/pages/index#">Diamond DA40</a> with a
                            Garmin G1000 glass
                            cockpit, a <a className="drop-shadow-md" href="src/main/webpack/pages/index#">Cessna
                            Skylane</a> with retractable
                            landing gear, and a <a className="drop-shadow-md" href="src/main/webpack/pages/index#">Piper
                            Archer</a>. Come join
                            our group of like minded pilots!
                        </div>
                        <div className="text-justify">
